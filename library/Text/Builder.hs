...
newtype Builder = Builder (Dev.TextBuilder)
...
thousandSeparatedDecimal = coerce Dev.thousandSeparatedDecimal
...
thousandSeparatedUnsignedDecimal = coerce Dev.thousandSeparatedUnsignedDecimal
...
dataSizeInBytesInDecimal = coerce Dev.dataSizeInBytesInDecimal
...
intercalate = coerce Dev.intercalate
